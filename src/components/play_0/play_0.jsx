    ...
    <div className="instructions-container">
      ...
      <div className="welcome-section">
        ...
        <p className="intro-text">
          Guhuza is an interactive and engaging quiz game that simulates the 
          real-world job-seeking experience. Progress through different levels, 
          test your knowledge, and compete for the top position on the leaderboard.
        </p>
      </div>
      ...
      <div className="instructions-box">
        <ol className="instructions-list">
          ...
          <li>
            <strong>Timer System:</strong> Each question has a <b>10-second</b> countdown. 
            If no answer is selected within the time, it will be considered incorrect.
          </li>
          <li>
            <strong>Completing a Level:</strong> Each level consists of <b>10 questions</b>. 
            After completing all questions, you will receive a score summary.
          </li>
          <li>
          ...
          <li>
            ...
            <b>Leaderboard</b> section to see how you compare with other players.
          </li>
          <li>
            <strong>Profile & Progress:</strong> Your completed levels, scores, and progress 
            are stored in the <b>Profile</b> section for future reference.
          </li>
          <li>
