                ...
                <p>Any points will be called as Guhuza Point | Guhuza Experience (GP | GxP).</p>
                    ...
                    <div className="achievements-grid">
                        <div className="achievement-row">
                            <div className="achievement-item"><img src="/src/assets/badges/1st Ranking.png" alt="Leaderboard King" /><p>Leaderboard King 1st place</p></div>
                            <div className="achievement-item"><img src="/src/assets/badges/2nd Ranking.png" alt="Silver Strategist" /><p>Silver Strategist  2nd place</p></div>
                            <div className="achievement-item"><img src="/src/assets/badges/3rd Ranking.png" alt="Bronze Challenger" /><p>Bronze Challenger 3rd place</p></div>
                        </div>
                        <div className="achievement-row">
