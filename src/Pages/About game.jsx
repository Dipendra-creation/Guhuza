...
const AboutGame = () => {
  return (
      ...
      <div className="container">
        ...
        <div className="achievement-row">
                ...
                <div className="achievement-item" data-title="Achieve 2nd rank to earn this badge"><img src="/src/assets/badges/2nd Ranking.png" alt="Silver Strategist" /><p>Silver Strategist</p></div>
                 <div className="achievement-item" data-title="Achieve 3rd rank to earn this badge"><img src="/src/assets/badges/3rd Ranking.png" alt="Bronze Challenger" /> <p>Bronze Challenger</p></div>
                 <div className="achievement-item" data-title="Log in for 30 consecutive days"><img src="/src/assets/badges/30 day login.png" alt="Loyal Player" /> <p>Loyal Player</p></div>
                 <div className="achievement-item" data-title="Share your achievements on social media"> <img src="/src/assets/badges/20 share.png" alt="Social Influencer" /> <p>Social Influencer</p></div></div>

            <div className="achievement-row">
                <div className="achievement-item" data-title="Refer 20 friends who sign up and play"><img src="/src/assets/badges/20 referral.png" alt="Referral Master" /> <p>Referral Master</p></div>
                <div className="achievement-item" data-title="Maintain 1st place for 3 consecutive months"><img src="/src/assets/badges/1st for 3 month.png" alt="Undisputed Champion" /><p>Undisputed Champion</p></div>
                <div className="achievement-item" data-title="Complete all 50 levels of the game"><img src="/src/assets/badges/all level completed.png" alt="Ultimate Quiz Master" /><p>Ultimate Quiz Master</p></div>
                <div className="achievement-item" data-title="Complete Level 40"><img src="/src/assets/badges/40 level completed.png" alt="Elite Finisher" /> <p>Elite Finisher</p></div>
                <div className="achievement-item" data-title="Complete Level 30"><img src="/src/assets/badges/30 level completed.png" alt="Determined Player" /><p>Determined Player</p></div>
            </div>

            <div className="achievement-row">
                <div className="achievement-item" data-title="Complete Expert Level (31-40)"> <img src="/src/assets/badges/expert level completed.png" alt="Expert Mind" /><p>Expert Mind</p></div>
                <div className="achievement-item" data-title="Complete Master Level (41-50)"><img src="/src/assets/badges/master level completed.png" alt="Master of Knowledge" /><p>Master of Knowledge</p></div>
                <div className="achievement-item" data-title="Earn 3000 GP"><img src="/src/assets/badges/earned 3000 GP.png" alt="Point Collector" /> <p>Point Collector</p></div>
                <div className="achievement-item" data-title="Reach 5000 GP"><img src="/src/assets/badges/earned 5000 GP.png" alt="Quiz Tycoon" /><p>Quiz Tycoon</p></div>
                <div className="achievement-item" data-title="Accumulate 7000 GP"><img src="/src/assets/badges/earned 7000 GP.png" alt="Legendary Gamer" /><p>Legendary Gamer</p>
            </div>
            </div>
    ...
    <p><strong>2. Point System:</strong> 
        Earned points (GP | GxP) are solely for in-game achievements and leaderboard rankings. These points have no monetary value and cannot be redeemed for cash or any other form of compensation.
    </p>

    <p><strong>3. Leaderboard Rankings:</strong> 
        Rankings are updated in real-time based on player performance. Any discrepancies should be reported within 24 hours of occurrence.
    </p>

    <p><strong>4. Account Responsibility:</strong> 
        Players are responsible for maintaining the security of their accounts. Sharing login credentials or using multiple accounts to gain an unfair advantage is strictly prohibited.
    </p>

    <p><strong>5. Technical Issues:</strong> 
        Guhuza is not liable for any disruptions, technical failures, or network issues affecting gameplay. Players are encouraged to ensure stable internet connectivity before participating.
    </p>

    <p><strong>6. Modification of Rules:</strong> 
